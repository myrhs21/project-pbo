...
<body class="bg-warning-70">
    <nav class="navbar navbar-expand-lg bg-warning">
        <div class="container">
            ...
            <img src="{{ asset('images/logo.JPG') }}" width="50" height="50" class="me-2">
            <strong>PT KARYA DATA INFOTAMA</strong>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link activate text-dark fs-5" aria-current="page" href="/"><strong>HOME</strong></a>
                    </li>
                    <li class="nav-item">
